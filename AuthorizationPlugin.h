 ...
 *  Mechanism are single threaded; the code does not have to guard
 *  agains multiple threads running inside the mechanism simultaneously.
 *
...
/**
 * PluginRecord is the per-login data structure. As the system only
 * instantiate a plugin one per plugin host, this information could
 ...
 * that these mechanism won't be running on different threads, data
...
- (OSStatus) MechanismCreate:(AuthorizationPluginRef)inPlugin
                ...
                MechanismRef:(AuthorizationMechanismRef _Nullable *_Nullable)outMechanism;
 ...
 * GUI sense of deactivating  window. After your plugin has deactivated
 ...
 * @param inMechanism AuthorizationMechanismRef
 *
 *  _Nullable@r_Nullablee_Nullableturn OSStatus
 */
 ...
 * All of the mechanism should have been destroyed by this time.
 *
 ...
 *
 * callback is a pointer to a bunch of callbacks that allow
 * your plugin to ask the systme to do operations on your behalf.
 *
...
- (OSStatus) AuthorizationPluginCreate:(const AuthorizationCallbacks *)callbacks
                             PluginRef:(AuthorizationPluginRef _Nonnull *_Nonnull)outPlugin
                       PluginInterface:(const AuthorizationPluginInterface *_Nonnull*_Nonnull)outPluginInterface;
